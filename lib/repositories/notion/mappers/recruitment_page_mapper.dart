...
class RecruitmentPageMapper extends DTOMapper<PageDTO, Recruitment> {
  ...
  Recruitment toModel(PageDTO dto) {
    ...
    return Recruitment(
      ...
      companyName: (properties['Nome azienda'] as RichTextDTO?)?.richText.firstOrNull?.plainText,
      urlWebsite: (properties['URL sito web'] as UrlDTO?)?.url,
      qualification: (properties['Qualifica'] as RichTextDTO?)?.richText.firstOrNull?.plainText,
      ...
      pay: (properties['Retribuzione'] as RichTextDTO?)?.richText.firstOrNull?.plainText,
      ...
      locality: (properties['Località'] as RichTextDTO?)?.richText.firstOrNull?.plainText,
    );
  }
